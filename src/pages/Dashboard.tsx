  ...
  return (
    <div className="min-h-screen bg-background text-text-main pb-24 md:pb-12">
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-8 py-6 space-y-6">
        ...
        <div className="bg-surface-card border border-border p-4 md:p-5 rounded-2xl space-y-4 shadow-lg">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="relative flex-1">
              <Input
                ...
                className="bg-surface border-primary/40 font-mono tracking-wide text-base md:text-lg py-3 focus:ring-primary shadow-inner"
              />
              {searchPlaca && (
                <button
                  onClick={() => {
                  ...
                  className="absolute right-3 top-3 text-xs text-text-muted hover:text-text-main px-2.5 py-1 bg-surface-card rounded border border-border"
                >
                  Limpar
                </button>
              )}
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={loadData}
                className="p-3 text-text-muted hover:text-primary transition-colors flex items-center gap-1.5 text-xs font-display uppercase tracking-wider bg-surface rounded-xl border border-border min-h-[48px]"
              >
          ...
          <div className="flex items-center gap-2 overflow-x-auto pb-1 scrollbar-none text-xs font-display uppercase tracking-wider">
            <button
              onClick={() => {
                triggerHaptic('light');
                setActiveTab('todas');
        ...
        <div className="flex items-center justify-between pt-2">
          <h2 className="text-lg font-bold font-display uppercase tracking-wider text-text-main flex items-center gap-2">
        ...
        {filteredList.length > 0 ? (
          ...
          <div className="p-12 text-center bg-surface-card border border-border rounded-2xl space-y-4">
            <Car className="w-16 h-16 text-text-muted/40 mx-auto" />
